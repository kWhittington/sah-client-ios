...
- (UIPageViewControllerSpineLocation)pageViewController:(UIPageViewController *)pageViewController
  ...
  if (UIInterfaceOrientationIsPortrait(orientation) ||
    ...
    // In portrait orientation or on iPhone: Set the spine position to "min" and the page view
    // controller's view controllers array to contain just one view controller. Setting the spine
    // position to 'UIPageViewControllerSpineLocationMid' in landscape orientation sets the
  ...
  // contain the current and next view controllers; if it is odd, set the array to contain the
