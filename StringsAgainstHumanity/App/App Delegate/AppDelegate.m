...
- (void)applicationWillResignActive:(UIApplication *)application {
  ...
  // This can occur for
  // certain types of temporary interruptions (such as an incoming phone call or
  // SMS message) or
...
- (void)applicationDidBecomeActive:(UIApplication *)application {
  ...
  // application was inactive. If
  // the application was previously in the background, optionally refresh the
  // user interface.
}
